...
describe('@ai: Gateway Plugins: AI Proxy Advanced Embedding Test', function () {
  ...
  type EmbeddingProvider = 'openai' | 'azure' | 'bedrock' | 'bedrock-titan-v1' | 'gemini' | 'gemini-vertex' | 'huggingface';

  // Use typed keys
  const providers: EmbeddingProvider[] = ['openai', 'azure', 'bedrock', 'bedrock-titan-v1', 'gemini', 'gemini-vertex', 'huggingface'];
