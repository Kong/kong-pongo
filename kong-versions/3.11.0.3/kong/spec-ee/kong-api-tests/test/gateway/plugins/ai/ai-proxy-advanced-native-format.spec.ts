...
xdescribe('@ai: Gateway Plugins: AI Proxy native format test', function () {
  ...
  async function validateLogsMetrics(provider: ProviderConfig, requestMode: string): Promise<void> {
    ...
    if (provider.case.endsWith('-chat')) {
  ...
  providers.forEach((provider) => {
    ...
    it(`should successfully generate metrics when streaming for ${provider.case} with logs`, async () => { await validateLogsMetrics(provider, "stream") })
