  ...
  */
  ...
  it('should be able to send prompt to gemini image generation model via route and to generate image', async function () {
    ...
    const resp = await retryAIRequest(
      makeRequest,
      (resp) => {
        validateImageGenerationResponse(resp, 'gemini');
        return resp;
      },
      'gemini'
    );
  ...
  it('should be able to collect logs for gemini image generation', async function () {
    ...
    await validateLogsMetrics("gemini", "gemini-2.5-flash-preview-image-generation");
  });
  ...
  it('should be able to collect logs for vertex image generation', async () => (await validateLogsMetrics("gemini", "gemini-2.5-flash-preview-image-generation")));
  ...
  it('should be able to collect logs for vertex image edit', async () => (await validateLogsMetrics("gemini", "gemini-2.5-flash-preview-image-generation")));
