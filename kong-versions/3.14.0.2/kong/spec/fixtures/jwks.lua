...
local client_ec_jwk = {
  kty = "EC",
  crv = "P-256",
  x   = "OJWl3FIO3TNTxehB_AkLo44wvNkIgRPYy6aLkpgW5rI",
  y   = "eJ_xjT0XvguD23_DpDUi-DbObQtW-D_aSgNstM2MvbE",
  d   = "_vg568F1esXizus5SpEeYGXNXuM7__bdB3oUI-4miB4",
  alg = "ES256",
  use = "sig",
  kid = "test-ec",
}

local client_ec_jwk_public = {
  kty = "EC",
  crv = "P-256",
  x   = "OJWl3FIO3TNTxehB_AkLo44wvNkIgRPYy6aLkpgW5rI",
  y   = "eJ_xjT0XvguD23_DpDUi-DbObQtW-D_aSgNstM2MvbE",
...
local client2_ec_jwk = {
  kty = "EC",
  crv = "P-256",
  x   = "4mUf2-jfLBnAaIr6ifbImZGbXQ5OiC0v6EFLdsAgv7M",
  y   = "qYfe2pVjezZ8CXBcjyQuyc-MLI8VS6-f98P1efRgN2Q",
  d   = "c7qm5wstWZoZl5TMQYUM2hFNQi0vWjnYgCAr1E_0KGk",
  alg = "ES256",
  use = "sig",
  kid = "test-ec-2",
}

local client2_ec_jwk_public = {
  kty = "EC",
  crv = "P-256",
  x   = "4mUf2-jfLBnAaIr6ifbImZGbXQ5OiC0v6EFLdsAgv7M",
  y   = "qYfe2pVjezZ8CXBcjyQuyc-MLI8VS6-f98P1efRgN2Q",
...
return {
  ...
  client_ec_jwk = client_ec_jwk,
  client_ec_jwk_public = client_ec_jwk_public,
  client2_ec_jwk = client2_ec_jwk,
  client2_ec_jwk_public = client2_ec_jwk_public,
}
