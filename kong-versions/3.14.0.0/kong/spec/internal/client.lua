...
-- `node_hostname`, `node_id`, `node_version`, `node_plugins_list`, `ssl_verify`.
-- If absent, they are automatically filled. `ssl_verify` defaults to `true`.
...
local function clustering_client(opts)
  ...
  local conn_opts = {
    ssl_verify = opts.ssl_verify == nil and true or opts.ssl_verify,
