...
describe('@oss: decK: validate redis legacy and new field deck sync with rate-limiting plugin', function () {
  ...
  //skip this due to issue in KAG-5774 waiting for resolve of FTI-6237
  it.skip('should not allow mismatched legacy and new redis field setting deck sync', async function () {
