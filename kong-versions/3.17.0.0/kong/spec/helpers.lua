...
-- @field envoy_proxy_host The host for the Envoy Redis proxy fixture, it can be set by env KONG_SPEC_TEST_ENVOY_PROXY_HOST.
-- @field envoy_proxy_port The port for the Envoy Redis proxy fixture, it can be set by env KONG_SPEC_TEST_ENVOY_PROXY_PORT.
-- @field envoy_backend_redis_host The host for the Redis backend behind the Envoy fixture, it can be set by env KONG_SPEC_TEST_ENVOY_BACKEND_REDIS_HOST.
-- @field envoy_backend_redis_port The port for the Redis backend behind the Envoy fixture, it can be set by env KONG_SPEC_TEST_ENVOY_BACKEND_REDIS_PORT.
...
-- @export
  ...
  envoy_proxy_host = CONSTANTS.ENVOY_PROXY_HOST,
  envoy_proxy_port = CONSTANTS.ENVOY_PROXY_PORT,
  envoy_backend_redis_host = CONSTANTS.ENVOY_BACKEND_REDIS_HOST,
  envoy_backend_redis_port = CONSTANTS.ENVOY_BACKEND_REDIS_PORT,
  ...
  wait_until_no_listen = wait.wait_until_no_listen,
