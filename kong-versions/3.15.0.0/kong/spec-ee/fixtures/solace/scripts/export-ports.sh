...
export KONG_SPEC_TEST_SOLACE_WEBHOOK_LOGS_PATH="${KONG_SPEC_TEST_SOLACE_WEBHOOK_LOGS_PATH:-${PWD}/webhook-consumer/logs}"
...
export KONG_SPEC_TEST_SOLACE_MQTT_LOGS_PATH="${KONG_SPEC_TEST_SOLACE_MQTT_LOGS_PATH:-${PWD}/mqtt-consumer/logs}"
echo "export KONG_SPEC_TEST_SOLACE_MQTT_LOGS_PATH=$KONG_SPEC_TEST_SOLACE_MQTT_LOGS_PATH"

# Keycloak HTTP port (8080) - used by openid-connect plugin to validate tokens
export KONG_SPEC_TEST_SOLACE_KEYCLOAK_PORT_8080=$(docker port solace-keycloak 8080/tcp | cut -d: -f2)
echo "export KONG_SPEC_TEST_SOLACE_KEYCLOAK_PORT_8080=$KONG_SPEC_TEST_SOLACE_KEYCLOAK_PORT_8080"