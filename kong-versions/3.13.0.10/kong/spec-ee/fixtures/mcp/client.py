...
class Client:
    ...
    async def interact(self):
        ...
        expectedKeys = tool.inputSchema.get("properties", {}).keys()
        args = {}
        for arg in dummy_arguments.keys():
            if arg in expectedKeys:
                args[arg] = dummy_arguments[arg]
