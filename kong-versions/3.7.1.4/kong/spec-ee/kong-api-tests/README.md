...
In the above example polly will record the request/response interaction and replay it using the response recording when the test is run again thereafter.\
