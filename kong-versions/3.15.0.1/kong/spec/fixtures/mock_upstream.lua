...
local function reject_web_socket_handshake_with_content_length(body, status, headers)
  ngx.status = status or ngx.HTTP_BAD_REQUEST
  return send_text_response(body, "application/json", headers)
end


local function reject_web_socket_handshake_chunked(body, status, headers)
  headers = headers or {}
  ...
  ngx.header["Trailer"] = headers["Trailer"] or headers["trailer"] or "X-Mock-WebSocket-Trailer"
...
return {
  ...
  reject_web_socket_handshake_with_content_length = reject_web_socket_handshake_with_content_length,
  reject_web_socket_handshake_chunked = reject_web_socket_handshake_chunked,
  store_log                   = store_log,
