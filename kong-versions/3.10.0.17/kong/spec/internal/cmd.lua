...
local wait_until_kong_status_ready = require("spec.internal.wait").wait_until_kong_status_ready
...
local function start_kong_multi(start_cfg_arr, check_status, timeout, step)
  ...
  for _, start_kong_params in ipairs(start_cfg_arr) do
    ...
    if check_status and not env.status_listen then
      status_listen_port = status_listen_port and status_listen_port + 1 or 8110
      env.status_listen = "127.0.0.1:" .. status_listen_port
    end
