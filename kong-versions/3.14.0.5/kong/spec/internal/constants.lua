...
local CONSTANTS = {
  ...
  ENVOY_PROXY_HOST = os.getenv("KONG_SPEC_TEST_ENVOY_PROXY_HOST") or "localhost",
  ENVOY_PROXY_PORT = tonumber(os.getenv("KONG_SPEC_TEST_ENVOY_PROXY_PORT") or 1999),
  ENVOY_BACKEND_REDIS_HOST = os.getenv("KONG_SPEC_TEST_ENVOY_BACKEND_REDIS_HOST") or "localhost",
  ENVOY_BACKEND_REDIS_PORT = tonumber(os.getenv("KONG_SPEC_TEST_ENVOY_BACKEND_REDIS_PORT") or 7379),
